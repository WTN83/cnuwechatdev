...
class IntelligentInterface{
     ...
     */
    public static function semanticSemproxy($query, $category, $openId, $city='', $latitude='', $longitude='', $region=''){
        ...
        // $template = urldecode(json_encode(url_encode($template)));
        // $template = url_encode($template);
